package com.nofrontier.book.core.services.email.providers;
...
import com.nofrontier.book.domain.exceptions.EmailServiceException;
...
public class JavaMailService implements EmailService {
	...
	public void sendMailTemplateHtml(EmailParams params) {
		...
		try {
			mimeMessageHelper.setFrom("not-answer@nofrontier.com.br",
					"E-NoFrontier");
