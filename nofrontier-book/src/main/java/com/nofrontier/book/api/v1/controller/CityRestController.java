...
import com.nofrontier.book.domain.services.ApiCityService;
...
public class CityRestController {
	...
	@Operation(summary = "Finds a City", description = "Finds a City", tags = {
			"Cities"}, responses = {
					@ApiResponse(description = "Success", responseCode = "200", content = @Content(schema = @Schema(implementation = CityResponse.class))),
					@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
					@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
					@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
					@ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
					@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content),})
	public CityResponse findById(@PathVariable(value = "id") Long id) {
	...
	@Operation(summary = "Finds all Cityes", description = "Finds all Cityes", tags = {
			"Cities"}, responses = {
					...
					@ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
					@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content),})
	public ResponseEntity<PagedModel<EntityModel<CityResponse>>> findAll(
	...
	public CityResponse create(@RequestBody @Valid CityRequest cityRequest) {
		return apiCityService.create(cityRequest);
	}
	...
	@Operation(summary = "Updates a City", description = "Updates a City by passing in a JSON, XML or YML representation of the city!", tags = {
			"Cities"}, responses = {
					@ApiResponse(description = "Updated", responseCode = "200", content = @Content(schema = @Schema(implementation = CityResponse.class))),
					@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
					@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
					@ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
					@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content),})
