package br.com.xfrontier.book.core.services.email.providers;
...
import br.com.xfrontier.book.domain.exceptions.EmailServiceException;
...
public class JavaMailService implements EmailService {
	...
	public void sendMailTemplateHtml(EmailParams params) {
		...
		try {
			mimeMessageHelper.setFrom("not-answer@xfrontier.com.br",
					"E-NoFrontier");
