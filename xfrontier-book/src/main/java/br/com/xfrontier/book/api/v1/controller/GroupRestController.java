...
public class GroupRestController {
	...
	@Operation(summary = "Finds a Group", description = "Finds a Group", tags = {
			"Groups"}, responses = {
					@ApiResponse(description = "Success", responseCode = "200", content = @Content(schema = @Schema(implementation = GroupDto.class))),
					@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
					@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
					@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
					@ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
					@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content),})
	public GroupDto findById(@PathVariable(value = "id") Long id) {
	...
	@Operation(summary = "Finds all Groups", description = "Finds all Groups", tags = {
			"Groups"}, responses = {
					...
					@ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
					@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content),})
	public ResponseEntity<PagedModel<EntityModel<GroupDto>>> findAll(
	...
	@Operation(summary = "Adds a new Group", description = "Adds a new Group by passing in a JSON, XML or YML representation of the group!", tags = {
			"Groups"}, responses = {
					...
					@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
					@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content),})
	public GroupDto create(@RequestBody @Valid GroupDto groupDtoRequest) {
		return apiGroupService.create(groupDtoRequest);
	}
	...
	@Operation(summary = "Updates a Group", description = "Updates a Group by passing in a JSON, XML or YML representation of the group!", tags = {
			"Groups"}, responses = {
					@ApiResponse(description = "Updated", responseCode = "200", content = @Content(schema = @Schema(implementation = GroupDto.class))),
					@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
					@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
					@ApiResponse(description = "Not Found", responseCode = "404", content = @Content),
					@ApiResponse(description = "Internal Error", responseCode = "500", content = @Content),})
	public GroupDto update(@PathVariable(value = "id") Long id, @RequestBody @Valid GroupDto groupDtoRequest) {
		return apiGroupService.update(id, groupDtoRequest);
	}
